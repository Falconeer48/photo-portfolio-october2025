...
# Create a simple Quick Action that actually works in modern macOS
...
print_status "$BLUE" "🔧 Creating simple Quick Action..."
    ...
    <array>
        <dict>
            ...
            <dict>
                ...
                <string>/Users/ian/Scripts/send-to-imac-printer.sh "$@"</string>
...
print_status "$GREEN" "✅ Simple Quick Action created"
...
print_status "$YELLOW" "1. Wait 2-3 minutes for macOS to recognize the service"
...
print_status "$GREEN" "✅ Simple Quick Action setup completed!"
